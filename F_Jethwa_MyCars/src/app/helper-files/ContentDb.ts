...
export const contents: Content[] = [
  {
    id: 0,
    title: 'Lamborghini',
    description: 'This is the description forLamborghini item',
    creator: 'FenilJ',
    imgURL: 'https://images.unsplash.com/photo-1525609004556-c46c7d6cf023?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=452&q=80',
    type: 'Super',
    tags: ['Tag 1.0', 'Tag 2.0']
  },
  {
    id: 1,
